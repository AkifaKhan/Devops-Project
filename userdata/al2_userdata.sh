...
if [ ! -d "reactapp" ]; then
  git clone https://github.com/AkifaKhan/reactapp.git
fi
...
server {
    listen 80;
    server_name akifa-al2.codelessops.site;
...
sudo certbot --nginx -d akifa-al2.codelessops.site --non-interactive --agree-tos -m akifakhan001@hotmail.com
