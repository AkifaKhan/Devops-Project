...
server {
    listen 80;
    server_name akifa-ubuntu.codelessops.site;
...
# Get HTTPS cert
certbot --nginx -d akifa-ubuntu.codelessops.site --non-interactive --agree-tos -m akifakhan001@hotmail.com || echo "Certbot failed — run it manually later"
